...
public class Zad3 extends Shape{
    ...
    public void draw(Graphics2D graphics2D) {
        ...
        graphics2D.drawLine((int) topLeftX, (int) topLeftY, (int) botLeftX, (int) botLeftY);
        graphics2D.drawLine((int) botRightX, (int) botRightY, (int) topRightX, (int) topRightY);
    ...
    public void calculate() {
        ...
        topLeftX = h + a * Math.cos(Math.PI / 4);
        topLeftY = k + b * Math.sin(Math.PI / 4);

        topRightX = h + a * Math.cos(3 * Math.PI / 4);
        topRightY = k + b * Math.sin(3 * Math.PI / 4);

        botLeftX = h + a * Math.cos(5 * Math.PI / 4);
        botLeftY = k + b * Math.sin(5 * Math.PI / 4);

        botRightX = h + a * Math.cos(7 * Math.PI / 4);
        botRightY = k + b * Math.sin(7 * Math.PI / 4);
    }
